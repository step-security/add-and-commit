...
const ACTION_ENTRY = path.join(REPO_ROOT, 'dist', 'index.js');
...
/**
 * Spawn the shipped action (dist/index.js) with an allowlisted environment.
 *
...
export function runAction(
  ...
  const merged: Record<string, string> = {
    // Mirror action.yml defaults that matter when spawning dist/ directly.
    cwd: '.',
    add: '.',
